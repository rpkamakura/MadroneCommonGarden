...
pertfiles <- list("033121PVFulldata.csv", "033121PHFulldata.csv", "033121SFFulldata.csv", "033121SOFulldata.csv")
...
#regdata <- lapply(list("033121_TotGrowth_BestMultReg.csv","040121_AmntDieback_BestMultReg.csv", "033121MortalityBestMultReg.csv"), read.csv)

regdata <- lapply(list("../Data Analysis/040121_TotGrowth_BestMultReg12to13.csv","../Data Analysis/040121_AmntDieback_BestMultReg12to13.csv", "../Data Analysis/033121MortalityBestMultReg12to13.csv"), read.csv)

#regdata <- lapply(list("../Data Analysis/040121_TotGrowth_BestMultReg12to13.csv","../Data Analysis/040121_AmntDieback_BestMultReg12to13.csv", "../Data Analysis/040121MortalityBestMultReg12to13.csv"), read.csv)

```


May not be able to use glm, might have to do some form of binomial? check out p. 28 at https://education.illinois.edu/docs/default-source/carolyn-anderson/edpsy589/lectures/Draft_glm_chapter_feb_2010.pdf

https://stats.idre.ucla.edu/r/dae/binomial-regression/
...
for (DepVar in regdata) {#For each response variable 
  ...
  if (iter == 1| iter ==2){
    #fulldata <-  IndivHeights_byTree(sitesdata, years, sites) #Growth Rate Data
  ...
  if (dvarnm == "TotGrowth"){ #check what the random variables are (what the dep var is)
    write.csv(overal_mod, "040221_TGR_BestModelResults12to13.csv")
    write.csv(param_mat, "040221_TGR_BestParamResults12to13.csv")
  } else if (dvarnm == "AmntDieback"){
    write.csv(overal_mod, "040221_ADBK_BestModelResults12to13.csv")
    write.csv(param_mat, "040221_ADBK_BestParamResults12to13.csv")
  } else if (dvarnm == "PercDead"){
    #write.csv(overal_mod, "0508Mort_BestModelResults12to13.csv")
    #write.csv(param_mat, "0508Mort_BestParamResults12to13.csv")
  }
...
functype <- c("E", "L", "Q", "Q", "Q", "Q", "Q", "Q", "Q")
  ...
  write.csv(overal_mod, "040121_Mort_BestModelResults12to13.csv")
  write.csv(param_mat, "040121_Mort_BestParamResults12to13.csv")
