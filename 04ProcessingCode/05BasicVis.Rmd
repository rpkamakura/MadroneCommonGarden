...
Notice here that the models I am diving into here are hardcoded, you can change the
variables (listed in the comments) to match ones that suit your analyses of interest
...
Same thing here as the first growth rates section, I hard-coded the variables of interest, 
you can change this to be whatever you want, this is just to illustrate
...
write.csv(storage_mat, "../05ProcessedDataOutputs/06BasicVis/Growth_estimates.csv")
...
Sane as the above but splitting up the years
...
write.csv(storage_mat, "../05ProcessedDataOutputs/06BasicVis/mortality_estimates.csv")
