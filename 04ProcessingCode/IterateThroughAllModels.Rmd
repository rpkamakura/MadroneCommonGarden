...
for (gstat in c(1,2)){
  ...
  write.csv(GR_AICmat, print(paste("../05ProcessedDataOutputs/", DepVar_name, "_BestMultReg.csv", sep='')))
...
write.csv(Mort_AICmat, "../05ProcessedDataOutputs/MortalityBestMultReg.csv")
