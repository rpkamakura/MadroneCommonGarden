...
colnms <- c("Site", "Dep_Var", "Indep_Var", "Estimate", "Stdev", "Pval")
num_rws <- 3 +9 + 17 + 6
...
write.csv(storage_mat, "040621growth_estimates.csv")
```
...
write.csv(storage_mat, "040621mortality_estimates.csv")
