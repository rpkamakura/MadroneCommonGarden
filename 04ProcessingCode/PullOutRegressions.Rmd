...
regdata <- lapply(list("../05ProcessedDataOutputs/TotGrowth_BestMultReg.csv", "../05ProcessedDataOutputs/MortalityBestMultReg.csv"), read.csv)

##NOTE, I DO NOT HAVE DIEBACK IN HERE BECAUSE WITH THE SIMULATED DATA, 
##DIEBACK DOESN'T WORK

#####For subset analysis
#regdata <- lapply(list("../05ProcessedDataOutputs/TotGrowth_BestMultReg12to13.csv","../05ProcessedDataOutputs/AmntDieback_BestMultReg12to13.csv", "../05ProcessedDataOutputs/MortalityBestMultReg12to13.csv"), read.csv)
...
#for (DepVar in regdata) {#For each response variable
  ...
  if (dvarnm == "TotGrowth"){ #check what the random variables are (what the dep var is)
    write.csv(overal_mod, "../05ProcessedDataOutputs/TGR_BestModelResult.csv")
    write.csv(param_mat, "../05ProcessedDataOutputs/TGR_BestParamResult.csv")
