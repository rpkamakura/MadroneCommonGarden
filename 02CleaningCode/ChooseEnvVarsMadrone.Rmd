...
library(vip)
source("../Data Analysis/032521PerSiteAnalys.R")
...
#write.csv(stomat, "033021LinREgressions.csv")



```
The variables you get from this ranking (top ~13): 

Ecoregion*
DD.5_at - autumn degree-days above 5°C
Dist*
Tave_at - autumn mean temperature (°C)
DD.18_at - autumn degree-days below 18°C
Eref_wt - winter Hargreaves reference evaporation (mm)
DD.5_wt - winter degree-days above 5°C
Tmax_wt - winter mean maximum temperature (°C)
DD.5 - degree-days above 5°C, growing degree-days
MCMT - mean coldest month temperature (°C),
DD.18_wt - winter degree-days below 18°C
...
top 5 for PH Mort (they're all trash tho)
Ecoregion*
DD.18_sm.1
DD.18.1
MWMT
...
variables with r2 > 0.1 at at least two sites, in decreasing order of sum of r2 values across
growth, dieback, and mortality at all sites:
...
for (i in 1:length(varlist)){
  ...
  if (length(v_inds) != 0){
    ...
    corr <- summary(lm(var1 ~ var2))$r.squared
...
#write.csv(output_mat, "ClimateVarCorrelations.csv")
...
write.csv(ClimWNew, "../Climate Data/033121LocClim.csv")
